...
export function printRequestQuote({ request, locale = "ar", printedBy }) {
  ...
  const fmtQty = (v) => {
    if (v == null || Number.isNaN(Number(v))) return "—";
    return new Intl.NumberFormat("en-US", { maximumFractionDigits: 3, minimumFractionDigits: 0 }).format(Number(v));
  };
...
<body>
  ...
  <div style="display:flex;justify-content:flex-end;margin-top:20px;">
    <div class="box" style="min-width:320px;">
      ...
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px;gap:24px;">
        <span style="color:#475569;font-size:13px;font-weight:600;">${L.summaryDiscount} (${request.discount_percent}%)</span>
      ...
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px;gap:24px;">
        <span style="color:#475569;font-size:13px;font-weight:600;">${L.summaryTax} (${request.tax_percent}%)</span>
